    ...
    <Layout>
      <section className="pt-32 pb-16">
        <div className="container mx-auto px-4">
          ...
          >
            <span className="inline-block py-1 px-3 rounded-full text-xs font-medium bg-brand-purple/10 text-blue-400 mb-4">
              About Me
            </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-1 gap-8 items-center mb-16">
            <motion.div
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  I'm <motion.span 
                    ...
                    whileHover={{ color: "#1234f7ff" }}
                  >Carl Weber</motion.span>, a Computer Science student specializing in AI & Machine Learning at Technical University of Munich(TUM), Germany.
                </p>
                <p>
                ...
                <p>
                  I'm passionate about building AI-powered web applications and software that is not only functional but also intuitive and user-friendly. I believe in continuous learning and staying updated with the latest technologies.
                </p>
                <p>
                  When I'm not coding, I enjoy exploring new technologies, solving algorithmic problems, contributing to open-source projects and sports such as football and table tennis.
                </p>
              </div>
            </motion.div>
          </div>
              ...
              {skills.map((skill, index) => (
                ...
                >
                  ...
                  <span className={`text-xs py-1 px-3 rounded-full ${
                    skill.level === 'Advanced' ? 'bg-brand-purple/20 text-blue-400' :
