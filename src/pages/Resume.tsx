...
const Resume = () => {
  ...
  const education = [
    {
      institution: "Technical Uninversity of Munich(TUM)",
  ...
  const experience = [
    {
      ...
      company: "TechSolutions GmnH, Hambrug, Germany",
      duration: "June 2021 - Present",
      description: "Integrated AI tools into development workflows for improved efficiency",
      responsibilities: [
        "Spearheaded the development of a comprehensive customer portal",
        "Designed and implemented a microservices architecture for the backend using Node.js, deployed on AWS Lambda",
        "Developed and integrated real-time features utilizing ChatGPT"
      ]
    },
    {
      position: "Software Developer",
      company: "Innovatech AG, Munich, Germany",
      ...
      responsibilities: [
        "Developed a scalable e-commerce platform featuring an Angular frontend and Django backend",
        "Automated deployment processes by implementing Jenkins and Docker",
        "Successfully integrated  PayPal, Stripe, and Square payment gateways",
      ]
    },
    {
      position: "Junior Web Developer",
      company: "WebWorks GmbH, Hambrug, Germany",
          ...
          >
            <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-2 mb-4">
              ...
              <div className="flex flex-col items-start md:items-end text-right">
                <div className="px-3 py-1 rounded-full text-sm bg-brand-purple/10 text-blue-400">
                  {edu.gpa}
                </div>
          ...
          >
            <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-2 mb-4">
              ...
              <div className="flex flex-wrap gap-2 items-center">
                <span className="text-xs py-1 px-3 bg-brand-purple/10 text-blue-400 rounded-full">
                  {project.type}
                </span>
    ...
    <Layout>
      <section className="pt-32 pb-16 relative z-10">
        <div className="container mx-auto px-4">
          ...
          >
            <span className="inline-block py-1 px-3 rounded-full text-xs font-medium bg-brand-purple/10 text-blue-400 mb-4 backdrop-blur-sm border border-brand-purple/20">
              Resume
            </span>
