  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      details: "carldev303@gmail.com",
      link: "mailto:carldev303@gmail.com",
    },
    {
      icon: <MapPin className="h-5 w-5 text-blue-400" />,
      title: "Location",
      details: "Munich, Germany",
      link: "https://maps.google.com/?q=Munich",
    },
  ];
  ...
  const socialLinks = [
    {
      ...
      name: "GitHub",
      url: "https://github.com/BinaryBrain/",
    },
    {
      icon: <Linkedin className="h-5 w-5" />,
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/carl-w-601ba9266/",
    },
    {
      icon: <Twitter className="h-5 w-5" />,
      name: "Twitter",
      url: "https://x.com/CarlW6389896490",
    },
  ];
  ...
  return (
    ...
    >
      <div className="glass-panel p-6 rounded-lg">
        <h2 className="text-xl font-bold mb-4 text-blue-400">Contact Information</h2>
      ...
      <div className="glass-panel p-4 rounded-lg">
        <h3 className="font-medium mb-2 text-blue-400">Response Time</h3>
